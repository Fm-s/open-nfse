...
**v0.11.0** — adoção do bundle XSD oficial **20260727** (em produção desde 10/08/2026): **CNPJ alfanumérico** aceito na validação XSD local, em `buildDpsId`/`buildEventoPedidoId` e nas consultas por chave/Id; correção oficial do `TSSerieDPS` (séries 90000–99999 rejeitadas).
